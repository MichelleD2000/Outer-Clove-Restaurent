...
<html lang="en">
  <head>
    ...
    <title>The Outer Clover Restaurant| Reservation</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg px-5 pt-4">
        <a class="navbar-brand" href="index.html">The Outer Clove Restaurant</a>
    ...
    <div class="container">
      ...
      <div class="text-center">&copy; Copyright The Outer Clover Restaurant 2023</div>
    </div>
  </footer>
